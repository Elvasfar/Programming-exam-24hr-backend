...
INSERT INTO discipline (discipline_name) VALUES
                                             ('1-milløb (atletik)'),
                                             ('10.000-meterløb (atletik)'),
                                             ('100-meterløb (atletik)'),
                                             ('110 meter hækkeløb'),
                                             ('1500-meterløb (atletik)'),
                                             ('200 meter hækkeløb'),
                                             ('200-meterløb (atletik)'),
                                             ('3000-meterløb (atletik)'),
                                             ('4 × 100-meterløb (atletik)'),
                                             ('4 × 400-meterløb (atletik)'),
                                             ('400 meter hækkeløb'),
                                             ('400-meterløb (atletik)'),
                                             ('4x400-meterløb blandet hold (atletik)'),
                                             ('5000-meter-løb (atletik)'),
                                             ('60 meter hækkeløb'),
                                             ('60-meterløb (atletik)'),
                                             ('800-meterløb (atletik)'),
                                             ('Cross (løbesport)'),
                                             ('Diskoskast (atletik)'),
                                             ('Femkamp (atletik)'),
                                             ('Forhindringsløb (atletik)'),
                                             ('Halvmaratonløb (løbesport)'),
                                             ('Hammerkast (atletik)'),
                                             ('Højdespring (atletik)'),
                                             ('Højdespring uden tilløb (atletik)'),
                                             ('Kastefemkamp (atletik)'),
                                             ('Kastetrekamp'),
                                             ('Kuglestød (atletik)'),
                                             ('Kørestolsrace'),
                                             ('Længdespring (atletik)'),
                                             ('Længdespring uden tilløb (atletik)'),
                                             ('Maratonløb (løbesport)'),
                                             ('Slyngboldkast (atletik)'),
                                             ('Spydkast (atletik)'),
                                             ('Stangspring (atletik)'),
                                             ('Syvkamp (atletik)'),
                                             ('Tikamp (atletik)'),
